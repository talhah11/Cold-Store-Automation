...
@Component({
  selector: 'ngx-humidity-dragger',
  templateUrl: './humidity-dragger.component.html',
  styleUrls: ['./humidity-dragger.component.scss'],
})
export class HumidityDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = HumidityDraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
