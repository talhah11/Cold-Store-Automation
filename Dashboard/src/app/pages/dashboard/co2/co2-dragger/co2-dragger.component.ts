...
@Component({
  selector: 'ngx-co2-dragger',
  templateUrl: './co2-dragger.component.html',
  styleUrls: ['./co2-dragger.component.scss'],
})
export class CO2DraggerComponent implements AfterViewInit, OnChanges {
  ...
  private invalidate(): void {
    this.bottomAngleRad = CO2DraggerComponent.toRad(this.bottomAngle);
    this.calculateVars();
